  ...
  'use strict';
    angular
      ...
      .controller('AppCtrl', function() {
        ...
        this.items = [{title: 'PHP Kitten Wars', image:'./assets/images/kittenwars.png', github:'https://github.com/vince-lynch/PHPKittenWars', heroku: 'https://mysterious-river-14065.herokuapp.com/', desc: 'An entirely PHP Restful app built on CRUD principles for the simple principle of mimicking and recreating the famous Kitten Wars Website, using PHP Scraping methods to glean the data from the original kitten wars site (later became the inspiration for Facebook)'},{title: 'Machine Learning Demo', image:'./assets/images/machinelearningdemo.png', github:'https://github.com/vince-lynch/machinelearningtests', heroku: 'https://nameless-caverns-86688.herokuapp.com/', desc: 'A Machine Learning demonstration I made in ConvNetJS (Deep Q Learning in the browser)'},
